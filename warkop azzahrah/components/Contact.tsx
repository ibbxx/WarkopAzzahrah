        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2 w-full text-center lg:text-left space-y-10">
            <div>
              ...
              <p className="text-stone-300 font-light tracking-wide">Bontoa, Mandai, Maros Regency<br />South Sulawesi</p>
            </div>
            ...
            <div>
              ...
              <div className="flex justify-center lg:justify-start space-x-4">
                <a href="https://www.instagram.com/warkopsop_azzahra/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-stone-400 hover:text-amber-500 transition-colors duration-300 transform hover:scale-110">
          ...
          <div className="lg:w-1/2 w-full h-96">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63589.38719101!2d119.47520256042479!3d-5.049051687753289!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dbef93b7ed6d053%3A0x5f79f0ab5ec844b5!2sWarkop%20%26%20Sop%20Saudara%20Azzahra!5e0!3m2!1sen!2sid!4v1767877951475!5m2!1sen!2sid"
              width="600"
              height="450"
              style={{ border: 0 }}
